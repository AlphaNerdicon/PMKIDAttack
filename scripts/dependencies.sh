...
if [[ "$1" = "install" ]]; then
	...
	if [[ -e /sd ]]; then
	    ...
	    opkg --dest sd install /sd/modules/PMKIDAttack/scripts/ipk/hcxtools_5.1.3-1_ar71xx.ipk >> $LOGFILE
		...
		opkg --dest sd install /sd/modules/PMKIDAttack/scripts/ipk/hcxdumptool_5.1.3-1_ar71xx.ipk >> $LOGFILE
        ...
        opkg install /sd/modules/PMKIDAttack/scripts/ipk/hcxtools_5.1.3-1_ar71xx.ipk
		...
		opkg install /sd/modules/PMKIDAttack/scripts/ipk/hcxdumptool_5.1.3-1_ar71xx.ipk
